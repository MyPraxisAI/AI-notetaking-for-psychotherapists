...
function UserHomePage() {
  ...
  // Initialize the router and Supabase client
  ...
  // Logout function with fallback mechanism
  const handleLogout = async () => {
    try {
      // Use the Makerkit signOut mutation
      ...
      // Try fallback approach with direct Supabase client
      try {
