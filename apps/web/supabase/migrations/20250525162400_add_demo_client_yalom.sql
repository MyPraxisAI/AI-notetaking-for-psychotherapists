...
For our next session, you might want to pay attention to your dreams, as they often provide valuable insights during periods of grief. Also, notice any memories of Marilyn or your father that arise during the week, along with the associated emotions.',
  ...
  INSERT INTO public.transcripts (
    ...
    '{"segments": [
        ...
        {"start_ms": 45500, "end_ms": 50000, "speaker": "client", "content": "Longing. Frustration. But also... guilt, which surprises me."},
        ...
        {"start_ms": 125500, "end_ms": 140000, "speaker": "client", "content": "You know, this reminds me of how I would work with patients. I''d help them sit with uncomfortable realizations without rushing to reassurance. But being on this side of the conversation is quite different. I find myself wanting you to tell me I was a good husband and father, that my work mattered."},
        ...
        {"start_ms": 147500, "end_ms": 155000, "speaker": "client", "content": "Yes, and I''m simultaneously analyzing it! Old habits die hard. But there''s something powerful about being vulnerable in this way. It''s different from writing about these concepts."},
        ...
        {"start_ms": 160500, "end_ms": 175000, "speaker": "client", "content": "Yes. And it''s terrifying and liberating at once. I''ve written that the two most powerful therapeutic experiences are the acceptance of one''s mortality and the realization that we must ultimately face our existential isolation alone. I''m living those truths now, without Marilyn."},
...
- Обращать внимание на любые признаки осложненного горя',
  ...
  INSERT INTO public.transcripts (
    ...
    '{"segments": [
      ...
      {"start_ms": 135500, "end_ms": 155000, "speaker": "client", "content": "Да. Я все время думаю о наших последних месяцах вместе. После ее диагноза рака у нас было это... это драгоценное время. Мы знали, что это заканчивается. Мы сказали все, что нужно было сказать. Это было прекрасно по-своему. Но теперь... теперь я остался здесь, в 93 года, задаваясь вопросом, какая моя цель без нее."},
...
Для нашей следующей сессии вы можете обратить внимание на свои сны, так как они часто предоставляют ценные инсайты в периоды горя. Также замечайте любые воспоминания о Мэрилин или вашем отце, которые возникают в течение недели, вместе с связанными эмоциями.',
  ...
  INSERT INTO public.transcripts (
    ...
    '{"segments": [
      ...
      {"start_ms": 40500, "end_ms": 48000, "speaker": "client", "content": "Тоска. Разочарование. Но также... вина, что меня удивляет."},
      ...
      {"start_ms": 142500, "end_ms": 155000, "speaker": "client", "content": "Да, и я одновременно анализирую это! Старые привычки умирают с трудом. Но есть что-то мощное в том, чтобы быть уязвимым таким образом. Это отличается от написания об этих концепциях."},
      ...
      {"start_ms": 160500, "end_ms": 175000, "speaker": "client", "content": "Да. И это одновременно ужасающе и освобождающе. Я писал, что два самых мощных терапевтических переживания — это принятие своей смертности и осознание, что мы в конечном итоге должны встретиться с нашей экзистенциальной изоляцией в одиночестве. Я живу этими истинами сейчас, без Мэрилин."},
