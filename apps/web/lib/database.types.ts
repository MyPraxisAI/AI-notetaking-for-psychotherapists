  ...
  public: {
    Tables: {
      ...
      accounts_memberships: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "admin_accounts_with_stats"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "accounts_memberships_account_id_fkey"
      ...
      therapists: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "therapists_geo_locality_id_fkey"
            columns: ["geo_locality_id"]
            isOneToOne: false
      ...
      therapists_approaches: {
        ...
        Relationships: [
          {
            foreignKeyName: "therapists_approaches_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "therapists_approaches_approach_id_fkey"
            columns: ["approach_id"]
            isOneToOne: false
            referencedRelation: "therapeutic_approaches"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "therapists_approaches_therapist_id_fkey"
            columns: ["therapist_id"]
            isOneToOne: false
            referencedRelation: "therapists"
            referencedColumns: ["id"]
      ...
      user_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_settings_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: true
            referencedRelation: "accounts"
            referencedColumns: ["id"]
    ...
    Views: {
      admin_accounts_with_stats: {
        Row: {
          ...
          sessions_duration_seconds: number | null
          slug: string | null
          updated_at: string | null
          updated_by: string | null
        }
    ...
    Enums: {
      app_permissions:
        ...
        | "members.manage"
        | "invites.manage"
      artifact_reference_type: "client" | "session" | "therapist"
      artifact_type:
